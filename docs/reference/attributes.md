...
| [oncontextmenu](../attribute/oncontextmenu.md) | 所有元素可见 | 触发上下文菜单时运行的脚本 |
...
| [onpaste](../attribute/onpaste.md) | 所有元素可见 | 当用户在元素中粘贴一些内容时运行的脚本 |
...
| [scope](../attribute/scope.md) | [\<th>](../tags/th.md) | 指定标题单元格是否是列、行或列或行组的标题 |
